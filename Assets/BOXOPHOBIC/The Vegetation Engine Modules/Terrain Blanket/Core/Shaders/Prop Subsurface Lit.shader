...
Shader "BOXOPHOBIC/The Vegetation Engine/Geometry/Prop Subsurface Lit (Blanket)"
{
	Properties
	{
		...
		[HideInInspector]_TerrainMetallicValue1("Terrain Metallic", Range( 0 , 1)) = 1
	...
	LOD 0
		...
		Pass
		{
			...
			uniform half _TerrainMetallicValue1;
			...
			v2f VertexFunction (appdata v  ) {
				...
				float3 VertexPosition3588_g83454 = v.vertex.xyz;
				float3 appendResult60_g83462 = (float3(v.ase_texcoord3.x , v.ase_texcoord3.z , v.ase_texcoord3.y));
				half3 Mesh_PivotsData2831_g83454 = ( appendResult60_g83462 * _VertexPivotMode );
				half3 Mesh_PivotsOS2291_g83454 = Mesh_PivotsData2831_g83454;
				half3 VertexPos40_g83531 = ( VertexPosition3588_g83454 - Mesh_PivotsOS2291_g83454 );
				half3 VertexPos40_g83532 = VertexPos40_g83531;
				float3 appendResult74_g83532 = (float3(VertexPos40_g83532.x , 0.0 , 0.0));
				half3 VertexPosRotationAxis50_g83532 = appendResult74_g83532;
				float3 break84_g83532 = VertexPos40_g83532;
				float3 appendResult81_g83532 = (float3(0.0 , break84_g83532.y , break84_g83532.z));
				half3 VertexPosOtherAxis82_g83532 = appendResult81_g83532;
				float temp_output_84_0_g83483 = _LayerVertexValue;
				float temp_output_19_0_g83487 = TVE_VertexUsage[(int)temp_output_84_0_g83483];
				float4 temp_output_94_19_g83483 = TVE_VertexCoords;
				float3 ase_worldPos = mul(unity_ObjectToWorld, float4( (v.vertex).xyz, 1 )).xyz;
				float3 vertexToFrag3890_g83454 = ase_worldPos;
				float3 WorldPosition3905_g83454 = vertexToFrag3890_g83454;
				float4x4 break19_g83491 = unity_ObjectToWorld;
				float3 appendResult20_g83491 = (float3(break19_g83491[ 0 ][ 3 ] , break19_g83491[ 1 ][ 3 ] , break19_g83491[ 2 ][ 3 ]));
				float3 temp_output_122_0_g83491 = Mesh_PivotsData2831_g83454;
				float3 PivotsOnly105_g83491 = (mul( unity_ObjectToWorld, float4( temp_output_122_0_g83491 , 0.0 ) ).xyz).xyz;
				half3 ObjectData20_g83493 = ( appendResult20_g83491 + PivotsOnly105_g83491 );
				half3 WorldData19_g83493 = ase_worldPos;
				#ifdef TVE_FEATURE_BATCHING
				float3 staticSwitch14_g83493 = WorldData19_g83493;
				#else
				float3 staticSwitch14_g83493 = ObjectData20_g83493;
				#endif
				float3 temp_output_114_0_g83491 = staticSwitch14_g83493;
				float3 vertexToFrag4224_g83454 = temp_output_114_0_g83491;
				float3 ObjectPosition4223_g83454 = vertexToFrag4224_g83454;
				float3 lerpResult7575_g83454 = lerp( WorldPosition3905_g83454 , ObjectPosition4223_g83454 , _VertexPositionMode);
				half2 UV97_g83483 = ( (temp_output_94_19_g83483).zw + ( (temp_output_94_19_g83483).xy * (lerpResult7575_g83454).xz ) );
				float4 tex2DArrayNode50_g83483 = SAMPLE_TEXTURE2D_ARRAY_LOD( TVE_VertexTex, sampler_Linear_Clamp, float3(UV97_g83483,temp_output_84_0_g83483), 0.0 );
				float4 temp_output_17_0_g83487 = tex2DArrayNode50_g83483;
				float4 temp_output_111_19_g83483 = TVE_VertexParams;
				float4 temp_output_3_0_g83487 = temp_output_111_19_g83483;
				float4 ifLocalVar18_g83487 = 0;
				UNITY_BRANCH 
				if( temp_output_19_0_g83487 >= 0.5 )
				ifLocalVar18_g83487 = temp_output_17_0_g83487;
				else
				ifLocalVar18_g83487 = temp_output_3_0_g83487;
				float4 lerpResult22_g83487 = lerp( temp_output_3_0_g83487 , temp_output_17_0_g83487 , temp_output_19_0_g83487);
				#ifdef SHADER_API_MOBILE
				float4 staticSwitch24_g83487 = lerpResult22_g83487;
				#else
				float4 staticSwitch24_g83487 = ifLocalVar18_g83487;
				#endif
				half4 Global_Vertex_Params4173_g83454 = staticSwitch24_g83487;
				float4 break322_g83521 = Global_Vertex_Params4173_g83454;
				float2 appendResult355_g83521 = (float2(break322_g83521.x , break322_g83521.y));
				float2 temp_output_356_0_g83521 = (appendResult355_g83521*2.0 + -1.0);
				float2 break357_g83521 = temp_output_356_0_g83521;
				float3 appendResult361_g83521 = (float3(break357_g83521.x , 0.0 , break357_g83521.y));
				float3 ase_parentObjectScale = ( 1.0 / float3( length( unity_WorldToObject[ 0 ].xyz ), length( unity_WorldToObject[ 1 ].xyz ), length( unity_WorldToObject[ 2 ].xyz ) ) );
				half2 Global_VertexOrientationOS7550_g83454 = (( mul( unity_WorldToObject, float4( appendResult361_g83521 , 0.0 ) ).xyz * ase_parentObjectScale )).xz;
				float2 lerpResult7535_g83454 = lerp( float2( 0,0 ) , Global_VertexOrientationOS7550_g83454 , _GlobalOrientation);
				float2 break7552_g83454 = lerpResult7535_g83454;
				float3 appendResult7553_g83454 = (float3(break7552_g83454.x , 0.0 , break7552_g83454.y));
				half3 Vertex_Orientation7542_g83454 = appendResult7553_g83454;
				half3 Angle44_g83531 = Vertex_Orientation7542_g83454;
				half Angle44_g83532 = (Angle44_g83531).z;
				half3 VertexPos40_g83533 = ( VertexPosRotationAxis50_g83532 + ( VertexPosOtherAxis82_g83532 * cos( Angle44_g83532 ) ) + ( cross( float3(1,0,0) , VertexPosOtherAxis82_g83532 ) * sin( Angle44_g83532 ) ) );
				float3 appendResult74_g83533 = (float3(0.0 , 0.0 , VertexPos40_g83533.z));
				half3 VertexPosRotationAxis50_g83533 = appendResult74_g83533;
				float3 break84_g83533 = VertexPos40_g83533;
				float3 appendResult81_g83533 = (float3(break84_g83533.x , break84_g83533.y , 0.0));
				half3 VertexPosOtherAxis82_g83533 = appendResult81_g83533;
				half Angle44_g83533 = -(Angle44_g83531).x;
				half3 Grass_Perspective2661_g83454 = half3(0,0,0);
				half3 _Vector11 = half3(1,1,1);
				half3 Vertex_Size1741_g83454 = _Vector11;
				half3 _Vector5 = half3(1,1,1);
				float3 Vertex_SizeFade1740_g83454 = _Vector5;
				half Global_VertexOffset7549_g83454 = break322_g83521.z;
				float3 ObjectPosition_Shifted7481_g83454 = ( ObjectPosition4223_g83454 - TVE_WorldOrigin );
				float3 ase_objectScale = float3( length( unity_ObjectToWorld[ 0 ].xyz ), length( unity_ObjectToWorld[ 1 ].xyz ), length( unity_ObjectToWorld[ 2 ].xyz ) );
				float3 appendResult7547_g83454 = (float3(0.0 , ( ( ( ( Global_VertexOffset7549_g83454 - ( (ObjectPosition_Shifted7481_g83454).y * _ConformOffsetMode ) ) + _ConformOffsetValue ) / ase_objectScale.y ) * _GlobalConform ) , 0.0));
				half3 Vertex_Offset7544_g83454 = appendResult7547_g83454;
				float3 lerpResult16_g83530 = lerp( VertexPosition3588_g83454 , ( ( ( ( VertexPosRotationAxis50_g83533 + ( VertexPosOtherAxis82_g83533 * cos( Angle44_g83533 ) ) + ( cross( float3(0,0,1) , VertexPosOtherAxis82_g83533 ) * sin( Angle44_g83533 ) ) ) + Grass_Perspective2661_g83454 ) * Vertex_Size1741_g83454 * Vertex_SizeFade1740_g83454 ) + Mesh_PivotsOS2291_g83454 + Vertex_Offset7544_g83454 ) , TVE_IsEnabled);
				float3 temp_output_4912_0_g83454 = lerpResult16_g83530;
				float3 Final_VertexPosition890_g83454 = ( temp_output_4912_0_g83454 + _DisableSRPBatcher );
				
				half2 Global_VertexOrientationWS7551_g83454 = temp_output_356_0_g83521;
				float2 break7779_g83454 = Global_VertexOrientationWS7551_g83454;
				float dotResult8067_g83454 = dot( Global_VertexOrientationWS7551_g83454 , Global_VertexOrientationWS7551_g83454 );
				float3 appendResult7781_g83454 = (float3(break7779_g83454.x , sqrt( ( 1.0 - saturate( dotResult8067_g83454 ) ) ) , break7779_g83454.y));
				float3 normalizeResult8063_g83454 = normalize( appendResult7781_g83454 );
				float3 worldToObjDir7782_g83454 = ASESafeNormalize( mul( unity_WorldToObject, float4( normalizeResult8063_g83454, 0 ) ).xyz );
				half Terrain_Blend_Offset8086_g83454 = _TerrainBlendOffsetValue;
				float3 WorldPosition_Shifted7477_g83454 = ( WorldPosition3905_g83454 - TVE_WorldOrigin );
				half Terrain_Mask_Vertex8085_g83454 = saturate( ( ( Global_VertexOffset7549_g83454 + ( Terrain_Blend_Offset8086_g83454 * _TerrainBlendNormalValue ) ) - (WorldPosition_Shifted7477_g83454).y ) );
				float3 lerpResult7784_g83454 = lerp( v.normal , worldToObjDir7782_g83454 , Terrain_Mask_Vertex8085_g83454);
				#ifdef TVE_TERRAIN
				float3 staticSwitch7896_g83454 = lerpResult7784_g83454;
				#else
				float3 staticSwitch7896_g83454 = v.normal;
				#endif
				
				float4 break33_g83520 = _second_uvs_mode;
				float2 temp_output_30_0_g83520 = ( v.ase_texcoord.xy * break33_g83520.x );
				float2 appendResult21_g83509 = (float2(v.texcoord1.xyzw.z , v.texcoord1.xyzw.w));
				float2 Mesh_DetailCoord3_g83454 = appendResult21_g83509;
				float2 temp_output_29_0_g83520 = ( Mesh_DetailCoord3_g83454 * break33_g83520.y );
				float2 temp_output_31_0_g83520 = ( (WorldPosition_Shifted7477_g83454).xz * break33_g83520.z );
				half2 Second_UVs_Tilling7656_g83454 = (_SecondUVs).xy;
				half2 Second_UVs_Scale7664_g83454 = ( 1.0 / Second_UVs_Tilling7656_g83454 );
				float2 lerpResult7660_g83454 = lerp( Second_UVs_Tilling7656_g83454 , Second_UVs_Scale7664_g83454 , _SecondUVsScaleMode);
				half2 Second_UVs_Offset7657_g83454 = (_SecondUVs).zw;
				float2 vertexToFrag11_g83519 = ( ( ( temp_output_30_0_g83520 + temp_output_29_0_g83520 + temp_output_31_0_g83520 ) * lerpResult7660_g83454 ) + Second_UVs_Offset7657_g83454 );
				o.ase_texcoord10.xy = vertexToFrag11_g83519;
				float vertexToFrag11_g83589 = saturate( ( ( Global_VertexOffset7549_g83454 + Terrain_Blend_Offset8086_g83454 ) - (WorldPosition_Shifted7477_g83454).y ) );
				o.ase_texcoord10.z = vertexToFrag11_g83589;
				o.ase_texcoord11.xyz = vertexToFrag3890_g83454;
				o.ase_texcoord12.xyz = vertexToFrag4224_g83454;
				...
				#endif
				float3 vertexValue = Final_VertexPosition890_g83454;
				#ifdef ASE_ABSOLUTE_VERTEX_POS
				...
				#endif
				v.vertex.w = 1;
				v.normal = staticSwitch7896_g83454;
				v.tangent = v.tangent;
				...
				) : SV_Target
			{
				...
				half2 Main_UVs15_g83454 = ( ( IN.ase_texcoord9.xy * (_MainUVs).xy ) + (_MainUVs).zw );
				float4 tex2DNode29_g83454 = SAMPLE_TEXTURE2D( _MainAlbedoTex, sampler_MainAlbedoTex, Main_UVs15_g83454 );
				float3 lerpResult6223_g83454 = lerp( float3( 1,1,1 ) , (tex2DNode29_g83454).rgb , _MainAlbedoValue);
				float4 tex2DNode35_g83454 = SAMPLE_TEXTURE2D( _MainMaskTex, sampler_Linear_Repeat, Main_UVs15_g83454 );
				half Main_Mask57_g83454 = tex2DNode35_g83454.b;
				float clampResult17_g83540 = clamp( Main_Mask57_g83454 , 0.0001 , 0.9999 );
				float temp_output_7_0_g83541 = _MainMaskMinValue;
				float temp_output_10_0_g83541 = ( _MainMaskMaxValue - temp_output_7_0_g83541 );
				half Main_Mask_Remap5765_g83454 = saturate( ( ( clampResult17_g83540 - temp_output_7_0_g83541 ) / ( temp_output_10_0_g83541 + 0.0001 ) ) );
				float lerpResult8007_g83454 = lerp( 1.0 , Main_Mask_Remap5765_g83454 , _MainColorMode);
				float4 lerpResult7986_g83454 = lerp( _MainColorTwo , _MainColor , lerpResult8007_g83454);
				half3 Main_Color_RGB7994_g83454 = (lerpResult7986_g83454).rgb;
				half3 Main_Albedo99_g83454 = ( lerpResult6223_g83454 * Main_Color_RGB7994_g83454 );
				float2 vertexToFrag11_g83519 = IN.ase_texcoord10.xy;
				half2 Second_UVs17_g83454 = vertexToFrag11_g83519;
				float4 tex2DNode89_g83454 = SAMPLE_TEXTURE2D( _SecondAlbedoTex, sampler_SecondAlbedoTex, Second_UVs17_g83454 );
				float3 lerpResult6225_g83454 = lerp( float3( 1,1,1 ) , (tex2DNode89_g83454).rgb , _SecondAlbedoValue);
				float4 tex2DNode33_g83454 = SAMPLE_TEXTURE2D( _SecondMaskTex, sampler_Linear_Repeat, Second_UVs17_g83454 );
				half Second_Mask81_g83454 = tex2DNode33_g83454.b;
				float clampResult17_g83543 = clamp( Second_Mask81_g83454 , 0.0001 , 0.9999 );
				float temp_output_7_0_g83544 = _SecondMaskMinValue;
				float temp_output_10_0_g83544 = ( _SecondMaskMaxValue - temp_output_7_0_g83544 );
				half Second_Mask_Remap6130_g83454 = saturate( ( ( clampResult17_g83543 - temp_output_7_0_g83544 ) / ( temp_output_10_0_g83544 + 0.0001 ) ) );
				float lerpResult8008_g83454 = lerp( 1.0 , Second_Mask_Remap6130_g83454 , _SecondColorMode);
				float4 lerpResult7997_g83454 = lerp( _SecondColorTwo , _SecondColor , lerpResult8008_g83454);
				half3 Second_Color_RGB8005_g83454 = (lerpResult7997_g83454).rgb;
				half3 Second_Albedo153_g83454 = ( lerpResult6225_g83454 * Second_Color_RGB8005_g83454 );
				#ifdef UNITY_COLORSPACE_GAMMA
				float staticSwitch1_g83553 = 2.0;
				#else
				float staticSwitch1_g83553 = 4.594794;
				#endif
				float3 lerpResult4834_g83454 = lerp( ( Main_Albedo99_g83454 * Second_Albedo153_g83454 * staticSwitch1_g83553 ) , Second_Albedo153_g83454 , _DetailBlendMode);
				float lerpResult6885_g83454 = lerp( Main_Mask57_g83454 , Second_Mask81_g83454 , _DetailMaskMode);
				float clampResult17_g83559 = clamp( lerpResult6885_g83454 , 0.0001 , 0.9999 );
				float temp_output_7_0_g83558 = _DetailMaskMinValue;
				float temp_output_10_0_g83558 = ( _DetailMaskMaxValue - temp_output_7_0_g83558 );
				half Detail_Mask_Texture6794_g83454 = saturate( ( ( clampResult17_g83559 - temp_output_7_0_g83558 ) / ( temp_output_10_0_g83558 + 0.0001 ) ) );
				half Mesh_DetailMask90_g83454 = IN.ase_color.b;
				half4 Normal_Packed45_g83539 = SAMPLE_TEXTURE2D( _MainNormalTex, sampler_Linear_Repeat, Main_UVs15_g83454 );
				float2 appendResult58_g83539 = (float2(( (Normal_Packed45_g83539).x * (Normal_Packed45_g83539).w ) , (Normal_Packed45_g83539).y));
				half2 Normal_Default50_g83539 = appendResult58_g83539;
				half2 Normal_ASTC41_g83539 = (Normal_Packed45_g83539).xy;
				#ifdef UNITY_ASTC_NORMALMAP_ENCODING
				float2 staticSwitch38_g83539 = Normal_ASTC41_g83539;
				#else
				float2 staticSwitch38_g83539 = Normal_Default50_g83539;
				#endif
				half2 Normal_NO_DTX544_g83539 = (Normal_Packed45_g83539).wy;
				#ifdef UNITY_NO_DXT5nm
				float2 staticSwitch37_g83539 = Normal_NO_DTX544_g83539;
				#else
				float2 staticSwitch37_g83539 = staticSwitch38_g83539;
				#endif
				float2 temp_output_6555_0_g83454 = ( (staticSwitch37_g83539*2.0 + -1.0) * _MainNormalValue );
				float3 appendResult7388_g83454 = (float3(temp_output_6555_0_g83454 , 1.0));
				float3 tanToWorld0 = float3( WorldTangent.x, WorldBiTangent.x, WorldNormal.x );
				float3 tanToWorld1 = float3( WorldTangent.y, WorldBiTangent.y, WorldNormal.y );
				float3 tanToWorld2 = float3( WorldTangent.z, WorldBiTangent.z, WorldNormal.z );
				float3 tanNormal7389_g83454 = appendResult7388_g83454;
				float3 worldNormal7389_g83454 = float3(dot(tanToWorld0,tanNormal7389_g83454), dot(tanToWorld1,tanNormal7389_g83454), dot(tanToWorld2,tanNormal7389_g83454));
				half3 Main_NormalWS7390_g83454 = worldNormal7389_g83454;
				float lerpResult6884_g83454 = lerp( Mesh_DetailMask90_g83454 , ((Main_NormalWS7390_g83454).y*0.5 + 0.5) , _DetailMeshMode);
				float clampResult17_g83557 = clamp( lerpResult6884_g83454 , 0.0001 , 0.9999 );
				float temp_output_7_0_g83556 = _DetailMeshMinValue;
				float temp_output_10_0_g83556 = ( _DetailMeshMaxValue - temp_output_7_0_g83556 );
				half Detail_Mask_Surface1540_g83454 = saturate( ( ( clampResult17_g83557 - temp_output_7_0_g83556 ) / ( temp_output_10_0_g83556 + 0.0001 ) ) );
				float clampResult17_g83560 = clamp( ( Detail_Mask_Texture6794_g83454 * Detail_Mask_Surface1540_g83454 ) , 0.0001 , 0.9999 );
				float temp_output_7_0_g83561 = _DetailBlendMinValue;
				float temp_output_10_0_g83561 = ( _DetailBlendMaxValue - temp_output_7_0_g83561 );
				half Detail_Mask147_g83454 = ( saturate( ( ( clampResult17_g83560 - temp_output_7_0_g83561 ) / ( temp_output_10_0_g83561 + 0.0001 ) ) ) * _DetailMode * _DetailValue );
				float3 lerpResult235_g83454 = lerp( Main_Albedo99_g83454 , lerpResult4834_g83454 , Detail_Mask147_g83454);
				#ifdef TVE_DETAIL
				float3 staticSwitch255_g83454 = lerpResult235_g83454;
				#else
				float3 staticSwitch255_g83454 = Main_Albedo99_g83454;
				#endif
				half3 Blend_Albedo_Detail265_g83454 = staticSwitch255_g83454;
				half3 Tint_Gradient_Color5769_g83454 = float3(1,1,1);
				half3 Tint_Noise_Color5770_g83454 = float3(1,1,1);
				half3 Tint_User_Color7335_g83454 = float3(1,1,1);
				float Mesh_Occlusion318_g83454 = IN.ase_color.g;
				float clampResult17_g83563 = clamp( Mesh_Occlusion318_g83454 , 0.0001 , 0.9999 );
				float temp_output_7_0_g83565 = _VertexOcclusionMinValue;
				float temp_output_10_0_g83565 = ( _VertexOcclusionMaxValue - temp_output_7_0_g83565 );
				half Occlusion_Mask6432_g83454 = saturate( ( ( clampResult17_g83563 - temp_output_7_0_g83565 ) / ( temp_output_10_0_g83565 + 0.0001 ) ) );
				float3 lerpResult2945_g83454 = lerp( (_VertexOcclusionColor).rgb , float3( 1,1,1 ) , Occlusion_Mask6432_g83454);
				half3 Occlusion_Color648_g83454 = lerpResult2945_g83454;
				half3 Matcap_Color7428_g83454 = half3(0,0,0);
				half3 Blend_Albedo_Tinted2808_g83454 = ( ( Blend_Albedo_Detail265_g83454 * Tint_Gradient_Color5769_g83454 * Tint_Noise_Color5770_g83454 * Tint_User_Color7335_g83454 * Occlusion_Color648_g83454 ) + Matcap_Color7428_g83454 );
				...
				half3 Terrain_Albedo8037_g83454 = ( (Blend_Albedo7468_g83651).xyz * (_TerrainColor).rgb );
				float vertexToFrag11_g83589 = IN.ase_texcoord10.z;
				half Terrain_Mask_Pixel7898_g83454 = vertexToFrag11_g83589;
				half2 Main_Normal137_g83454 = temp_output_6555_0_g83454;
				float2 lerpResult3372_g83454 = lerp( float2( 0,0 ) , Main_Normal137_g83454 , _DetailNormalValue);
				float3x3 ase_worldToTangent = float3x3(WorldTangent,WorldBiTangent,WorldNormal);
				half4 Normal_Packed45_g83542 = SAMPLE_TEXTURE2D( _SecondNormalTex, sampler_Linear_Repeat, Second_UVs17_g83454 );
				float2 appendResult58_g83542 = (float2(( (Normal_Packed45_g83542).x * (Normal_Packed45_g83542).w ) , (Normal_Packed45_g83542).y));
				half2 Normal_Default50_g83542 = appendResult58_g83542;
				half2 Normal_ASTC41_g83542 = (Normal_Packed45_g83542).xy;
				#ifdef UNITY_ASTC_NORMALMAP_ENCODING
				float2 staticSwitch38_g83542 = Normal_ASTC41_g83542;
				#else
				float2 staticSwitch38_g83542 = Normal_Default50_g83542;
				#endif
				half2 Normal_NO_DTX544_g83542 = (Normal_Packed45_g83542).wy;
				#ifdef UNITY_NO_DXT5nm
				float2 staticSwitch37_g83542 = Normal_NO_DTX544_g83542;
				#else
				float2 staticSwitch37_g83542 = staticSwitch38_g83542;
				#endif
				float2 temp_output_6560_0_g83454 = ( (staticSwitch37_g83542*2.0 + -1.0) * _SecondNormalValue );
				half2 Normal_Planar45_g83545 = temp_output_6560_0_g83454;
				float2 break64_g83545 = Normal_Planar45_g83545;
				float3 appendResult65_g83545 = (float3(break64_g83545.x , 0.0 , break64_g83545.y));
				float2 ifLocalVar7655_g83454 = 0;
				if( _SecondUVsMode == 2.0 )
				ifLocalVar7655_g83454 = (mul( ase_worldToTangent, appendResult65_g83545 )).xy;
				else if( _SecondUVsMode < 2.0 )
				ifLocalVar7655_g83454 = temp_output_6560_0_g83454;
				half2 Second_Normal179_g83454 = ifLocalVar7655_g83454;
				float2 temp_output_36_0_g83554 = ( lerpResult3372_g83454 + Second_Normal179_g83454 );
				float2 lerpResult3376_g83454 = lerp( Main_Normal137_g83454 , temp_output_36_0_g83554 , Detail_Mask147_g83454);
				#ifdef TVE_DETAIL
				float2 staticSwitch267_g83454 = lerpResult3376_g83454;
				#else
				float2 staticSwitch267_g83454 = Main_Normal137_g83454;
				#endif
				half2 Blend_Normal_Detail312_g83454 = staticSwitch267_g83454;
				float3 appendResult7888_g83454 = (float3(Blend_Normal_Detail312_g83454 , 1.0));
				float3 tanNormal7889_g83454 = appendResult7888_g83454;
				float3 worldNormal7889_g83454 = float3(dot(tanToWorld0,tanNormal7889_g83454), dot(tanToWorld1,tanNormal7889_g83454), dot(tanToWorld2,tanNormal7889_g83454));
				half3 Blend_NormalWS_Detail7890_g83454 = worldNormal7889_g83454;
				float temp_output_7901_0_g83454 = saturate( (Blend_NormalWS_Detail7890_g83454).y );
				float temp_output_7895_0_g83454 = ( temp_output_7901_0_g83454 * temp_output_7901_0_g83454 * temp_output_7901_0_g83454 * temp_output_7901_0_g83454 );
				half Terrain_Mask_Projection7875_g83454 = ( temp_output_7895_0_g83454 * _TerrainMode );
				float temp_output_7_0_g83588 = _TerrainBlendMinValue;
				float temp_output_10_0_g83588 = ( _TerrainBlendMaxValue - temp_output_7_0_g83588 );
				half Terrain_Mask7747_g83454 = saturate( ( ( saturate( ( Terrain_Mask_Pixel7898_g83454 + ( Terrain_Mask_Pixel7898_g83454 * Terrain_Mask_Projection7875_g83454 ) ) ) - temp_output_7_0_g83588 ) / ( temp_output_10_0_g83588 + 0.0001 ) ) );
				float3 lerpResult7748_g83454 = lerp( Blend_Albedo_Tinted2808_g83454 , Terrain_Albedo8037_g83454 , Terrain_Mask7747_g83454);
				#ifdef TVE_TERRAIN
				float3 staticSwitch7792_g83454 = lerpResult7748_g83454;
				#else
				float3 staticSwitch7792_g83454 = Blend_Albedo_Tinted2808_g83454;
				#endif
				half3 Blend_Albedo_Terrain7752_g83454 = staticSwitch7792_g83454;
				float3 temp_output_3_0_g83581 = Blend_Albedo_Terrain7752_g83454;
				float dotResult20_g83581 = dot( temp_output_3_0_g83581 , float3(0.2126,0.7152,0.0722) );
				half Blend_Albedo_Grayscale5939_g83454 = dotResult20_g83581;
				float3 temp_cast_10 = (Blend_Albedo_Grayscale5939_g83454).xxx;
				float temp_output_82_0_g83473 = _LayerColorsValue;
				float temp_output_19_0_g83477 = TVE_ColorsUsage[(int)temp_output_82_0_g83473];
				float4 temp_output_91_19_g83473 = TVE_ColorsCoords;
				float3 vertexToFrag3890_g83454 = IN.ase_texcoord11.xyz;
				float3 WorldPosition3905_g83454 = vertexToFrag3890_g83454;
				float3 vertexToFrag4224_g83454 = IN.ase_texcoord12.xyz;
				float3 ObjectPosition4223_g83454 = vertexToFrag4224_g83454;
				float3 lerpResult4822_g83454 = lerp( WorldPosition3905_g83454 , ObjectPosition4223_g83454 , _ColorsPositionMode);
				half2 UV94_g83473 = ( (temp_output_91_19_g83473).zw + ( (temp_output_91_19_g83473).xy * (lerpResult4822_g83454).xz ) );
				float4 tex2DArrayNode83_g83473 = SAMPLE_TEXTURE2D_ARRAY_LOD( TVE_ColorsTex, sampler_Linear_Clamp, float3(UV94_g83473,temp_output_82_0_g83473), 0.0 );
				float4 temp_output_17_0_g83477 = tex2DArrayNode83_g83473;
				float4 temp_output_92_86_g83473 = TVE_ColorsParams;
				float4 temp_output_3_0_g83477 = temp_output_92_86_g83473;
				float4 ifLocalVar18_g83477 = 0;
				UNITY_BRANCH 
				if( temp_output_19_0_g83477 >= 0.5 )
				ifLocalVar18_g83477 = temp_output_17_0_g83477;
				else
				ifLocalVar18_g83477 = temp_output_3_0_g83477;
				float4 lerpResult22_g83477 = lerp( temp_output_3_0_g83477 , temp_output_17_0_g83477 , temp_output_19_0_g83477);
				#ifdef SHADER_API_MOBILE
				float4 staticSwitch24_g83477 = lerpResult22_g83477;
				#else
				float4 staticSwitch24_g83477 = ifLocalVar18_g83477;
				#endif
				half4 Global_Colors_Params5434_g83454 = staticSwitch24_g83477;
				float4 temp_output_346_0_g83461 = Global_Colors_Params5434_g83454;
				half Global_Colors_A1701_g83454 = saturate( (temp_output_346_0_g83461).w );
				half Colors_Influence3668_g83454 = Global_Colors_A1701_g83454;
				float temp_output_6306_0_g83454 = ( 1.0 - Colors_Influence3668_g83454 );
				float3 lerpResult3618_g83454 = lerp( Blend_Albedo_Terrain7752_g83454 , temp_cast_10 , ( 1.0 - ( temp_output_6306_0_g83454 * temp_output_6306_0_g83454 ) ));
				half3 Global_Colors_RGB1700_g83454 = (temp_output_346_0_g83461).xyz;
				#ifdef UNITY_COLORSPACE_GAMMA
				float staticSwitch1_g83570 = 2.0;
				#else
				float staticSwitch1_g83570 = 4.594794;
				#endif
				half3 Colors_RGB1954_g83454 = ( Global_Colors_RGB1700_g83454 * staticSwitch1_g83570 * _ColorsIntensityValue );
				float lerpResult6617_g83454 = lerp( Main_Mask_Remap5765_g83454 , Second_Mask_Remap6130_g83454 , Detail_Mask147_g83454);
				#ifdef TVE_DETAIL
				float staticSwitch6623_g83454 = lerpResult6617_g83454;
				#else
				float staticSwitch6623_g83454 = Main_Mask_Remap5765_g83454;
				#endif
				half Blend_MaskRemap_Detail6621_g83454 = staticSwitch6623_g83454;
				...
				half Terrain_ColorsMask7937_g83454 = ( (Blend_Specular7446_g83651).a * (Blend_Albedo7468_g83651).w );
				float lerpResult7939_g83454 = lerp( Blend_MaskRemap_Detail6621_g83454 , Terrain_ColorsMask7937_g83454 , Terrain_Mask7747_g83454);
				#ifdef TVE_TERRAIN
				float staticSwitch7922_g83454 = lerpResult7939_g83454;
				#else
				float staticSwitch7922_g83454 = Blend_MaskRemap_Detail6621_g83454;
				#endif
				half Blend_ColorsMask_Terrain7921_g83454 = staticSwitch7922_g83454;
				half Colors_Value3692_g83454 = ( Blend_ColorsMask_Terrain7921_g83454 * _GlobalColors );
				half Colors_Variation3650_g83454 = 1.0;
				half Occlusion_Alpha6463_g83454 = _VertexOcclusionColor.a;
				float lerpResult8028_g83454 = lerp( Occlusion_Mask6432_g83454 , ( 1.0 - Occlusion_Mask6432_g83454 ) , _VertexOcclusionColorsMode);
				float lerpResult8026_g83454 = lerp( Occlusion_Alpha6463_g83454 , 1.0 , lerpResult8028_g83454);
				half Occlusion_Colors6450_g83454 = lerpResult8026_g83454;
				float3 temp_output_3_0_g83582 = ( Blend_Albedo_Terrain7752_g83454 * Tint_Gradient_Color5769_g83454 * Tint_Noise_Color5770_g83454 * Tint_User_Color7335_g83454 );
				float dotResult20_g83582 = dot( temp_output_3_0_g83582 , float3(0.2126,0.7152,0.0722) );
				float clampResult6740_g83454 = clamp( saturate( ( dotResult20_g83582 * 5.0 ) ) , 0.2 , 1.0 );
				half Blend_Albedo_Globals6410_g83454 = clampResult6740_g83454;
				float temp_output_7_0_g83578 = 0.1;
				float temp_output_10_0_g83578 = ( 0.2 - temp_output_7_0_g83578 );
				float lerpResult16_g83571 = lerp( 0.0 , saturate( ( ( ( Colors_Value3692_g83454 * Colors_Influence3668_g83454 * Colors_Variation3650_g83454 * Occlusion_Colors6450_g83454 * Blend_Albedo_Globals6410_g83454 ) - temp_output_7_0_g83578 ) / ( temp_output_10_0_g83578 + 0.0001 ) ) ) , TVE_IsEnabled);
				float3 lerpResult3628_g83454 = lerp( Blend_Albedo_Terrain7752_g83454 , ( lerpResult3618_g83454 * Colors_RGB1954_g83454 ) , lerpResult16_g83571);
				half3 Blend_Albedo_Colored_High6027_g83454 = lerpResult3628_g83454;
				half3 Blend_Albedo_Colored863_g83454 = Blend_Albedo_Colored_High6027_g83454;
				half3 Global_OverlayColor1758_g83454 = (TVE_OverlayColor).rgb;
				float temp_output_84_0_g83468 = _LayerExtrasValue;
				float temp_output_19_0_g83472 = TVE_ExtrasUsage[(int)temp_output_84_0_g83468];
				float4 temp_output_93_19_g83468 = TVE_ExtrasCoords;
				float3 lerpResult4827_g83454 = lerp( WorldPosition3905_g83454 , ObjectPosition4223_g83454 , _ExtrasPositionMode);
				half2 UV96_g83468 = ( (temp_output_93_19_g83468).zw + ( (temp_output_93_19_g83468).xy * (lerpResult4827_g83454).xz ) );
				float4 tex2DArrayNode48_g83468 = SAMPLE_TEXTURE2D_ARRAY_LOD( TVE_ExtrasTex, sampler_Linear_Clamp, float3(UV96_g83468,temp_output_84_0_g83468), 0.0 );
				float4 temp_output_17_0_g83472 = tex2DArrayNode48_g83468;
				float4 temp_output_94_85_g83468 = TVE_ExtrasParams;
				float4 temp_output_3_0_g83472 = temp_output_94_85_g83468;
				float4 ifLocalVar18_g83472 = 0;
				UNITY_BRANCH 
				if( temp_output_19_0_g83472 >= 0.5 )
				ifLocalVar18_g83472 = temp_output_17_0_g83472;
				else
				ifLocalVar18_g83472 = temp_output_3_0_g83472;
				float4 lerpResult22_g83472 = lerp( temp_output_3_0_g83472 , temp_output_17_0_g83472 , temp_output_19_0_g83472);
				#ifdef SHADER_API_MOBILE
				float4 staticSwitch24_g83472 = lerpResult22_g83472;
				#else
				float4 staticSwitch24_g83472 = ifLocalVar18_g83472;
				#endif
				half4 Global_Extras_Params5440_g83454 = staticSwitch24_g83472;
				float4 break456_g83481 = Global_Extras_Params5440_g83454;
				half Global_Extras_Overlay156_g83454 = break456_g83481.z;
				half Overlay_Variation4560_g83454 = 1.0;
				half Overlay_Value5738_g83454 = ( _GlobalOverlay * Global_Extras_Overlay156_g83454 * Overlay_Variation4560_g83454 );
				...
				half2 Terrain_Normal8038_g83454 = ( (mul( ase_worldToTangent, appendResult65_g83747 )).xy * _TerrainNormalValue );
				float2 lerpResult7797_g83454 = lerp( Blend_Normal_Detail312_g83454 , Terrain_Normal8038_g83454 , Terrain_Mask7747_g83454);
				#ifdef TVE_TERRAIN
				float2 staticSwitch7796_g83454 = lerpResult7797_g83454;
				#else
				float2 staticSwitch7796_g83454 = Blend_Normal_Detail312_g83454;
				#endif
				half2 Blend_Normal_Terrain7762_g83454 = staticSwitch7796_g83454;
				float3 appendResult7377_g83454 = (float3(Blend_Normal_Terrain7762_g83454 , 1.0));
				float3 tanNormal7376_g83454 = appendResult7377_g83454;
				float3 worldNormal7376_g83454 = float3(dot(tanToWorld0,tanNormal7376_g83454), dot(tanToWorld1,tanNormal7376_g83454), dot(tanToWorld2,tanNormal7376_g83454));
				half3 Blend_NormalWS_Terrain7375_g83454 = worldNormal7376_g83454;
				half Vertex_DynamicMode5112_g83454 = _VertexDynamicMode;
				float lerpResult7446_g83454 = lerp( (Blend_NormalWS_Terrain7375_g83454).y , IN.ase_normal.y , Vertex_DynamicMode5112_g83454);
				float lerpResult6757_g83454 = lerp( 1.0 , saturate( lerpResult7446_g83454 ) , _OverlayProjectionValue);
				half Overlay_Projection6081_g83454 = lerpResult6757_g83454;
				half Overlay_Shading6688_g83454 = Blend_Albedo_Globals6410_g83454;
				half Overlay_Custom6707_g83454 = 1.0;
				float lerpResult8034_g83454 = lerp( Occlusion_Mask6432_g83454 , ( 1.0 - Occlusion_Mask6432_g83454 ) , _VertexOcclusionOverlayMode);
				float lerpResult8032_g83454 = lerp( Occlusion_Alpha6463_g83454 , 1.0 , lerpResult8034_g83454);
				half Occlusion_Overlay6471_g83454 = lerpResult8032_g83454;
				float temp_output_7_0_g83577 = 0.1;
				float temp_output_10_0_g83577 = ( 0.2 - temp_output_7_0_g83577 );
				half Overlay_Mask_High6064_g83454 = saturate( ( ( ( Overlay_Value5738_g83454 * Overlay_Projection6081_g83454 * Overlay_Shading6688_g83454 * Overlay_Custom6707_g83454 * Occlusion_Overlay6471_g83454 ) - temp_output_7_0_g83577 ) / ( temp_output_10_0_g83577 + 0.0001 ) ) );
				half Overlay_Mask269_g83454 = Overlay_Mask_High6064_g83454;
				float3 lerpResult336_g83454 = lerp( Blend_Albedo_Colored863_g83454 , Global_OverlayColor1758_g83454 , Overlay_Mask269_g83454);
				half3 Blend_Albedo_Overlay359_g83454 = lerpResult336_g83454;
				half Global_WetnessContrast6502_g83454 = TVE_WetnessContrast;
				half Global_Extras_Wetness305_g83454 = break456_g83481.y;
				half Wetness_Value6343_g83454 = ( Global_Extras_Wetness305_g83454 * _GlobalWetness );
				float3 lerpResult6367_g83454 = lerp( Blend_Albedo_Overlay359_g83454 , ( Blend_Albedo_Overlay359_g83454 * Blend_Albedo_Overlay359_g83454 ) , ( Global_WetnessContrast6502_g83454 * Wetness_Value6343_g83454 ));
				half3 Blend_Albedo_Wetness6351_g83454 = lerpResult6367_g83454;
				float3 _Vector10 = float3(1,1,1);
				half3 Tint_Highlight_Color5771_g83454 = _Vector10;
				float3 temp_output_6309_0_g83454 = ( Blend_Albedo_Wetness6351_g83454 * Tint_Highlight_Color5771_g83454 );
				half3 Blend_Albedo_Subsurface149_g83454 = temp_output_6309_0_g83454;
				half3 Blend_Albedo_RimLight7316_g83454 = Blend_Albedo_Subsurface149_g83454;
				
				half Global_OverlayNormalScale6581_g83454 = TVE_OverlayNormalValue;
				float lerpResult6585_g83454 = lerp( 1.0 , Global_OverlayNormalScale6581_g83454 , Overlay_Mask269_g83454);
				half2 Blend_Normal_Overlay366_g83454 = ( Blend_Normal_Terrain7762_g83454 * lerpResult6585_g83454 );
				half Global_WetnessNormalScale6571_g83454 = TVE_WetnessNormalValue;
				float lerpResult6579_g83454 = lerp( 1.0 , Global_WetnessNormalScale6571_g83454 , ( Wetness_Value6343_g83454 * Wetness_Value6343_g83454 ));
				half2 Blend_Normal_Wetness6372_g83454 = ( Blend_Normal_Overlay366_g83454 * lerpResult6579_g83454 );
				float3 appendResult6568_g83454 = (float3(Blend_Normal_Wetness6372_g83454 , 1.0));
				float3 temp_output_13_0_g83482 = appendResult6568_g83454;
				float3 temp_output_33_0_g83482 = ( temp_output_13_0_g83482 * _render_normals );
				float3 switchResult12_g83482 = (((ase_vface>0)?(temp_output_13_0_g83482):(temp_output_33_0_g83482)));
				
				float3 temp_cast_19 = (0.0).xxx;
				half3 Emissive_Color7162_g83454 = (_EmissiveColor).rgb;
				half2 Emissive_UVs2468_g83454 = ( ( IN.ase_texcoord9.xy * (_EmissiveUVs).xy ) + (_EmissiveUVs).zw );
				float temp_output_7_0_g83586 = _EmissiveTexMinValue;
				float3 temp_cast_20 = (temp_output_7_0_g83586).xxx;
				float temp_output_10_0_g83586 = ( _EmissiveTexMaxValue - temp_output_7_0_g83586 );
				half3 Emissive_Texture7022_g83454 = saturate( ( ( (SAMPLE_TEXTURE2D( _EmissiveTex, sampler_Linear_Repeat, Emissive_UVs2468_g83454 )).rgb - temp_cast_20 ) / ( temp_output_10_0_g83586 + 0.0001 ) ) );
				half Global_Extras_Emissive4203_g83454 = break456_g83481.x;
				float lerpResult4206_g83454 = lerp( 1.0 , Global_Extras_Emissive4203_g83454 , _GlobalEmissive);
				half Emissive_Value7024_g83454 = ( ( lerpResult4206_g83454 * _EmissivePhaseValue ) - 1.0 );
				half3 Emissive_Mask6968_g83454 = saturate( ( Emissive_Texture7022_g83454 + Emissive_Value7024_g83454 ) );
				float3 temp_output_3_0_g83585 = ( Emissive_Color7162_g83454 * Emissive_Mask6968_g83454 );
				float temp_output_15_0_g83585 = _emissive_intensity_value;
				float3 temp_output_23_0_g83585 = ( temp_output_3_0_g83585 * temp_output_15_0_g83585 );
				#ifdef TVE_EMISSIVE
				float3 staticSwitch8018_g83454 = temp_output_23_0_g83585;
				#else
				float3 staticSwitch8018_g83454 = temp_cast_19;
				#endif
				half3 Blend_Emissive2476_g83454 = staticSwitch8018_g83454;
				half3 Terrain_Emissive7933_g83454 = ( (Blend_Specular7446_g83651).rgb * (Blend_Albedo7468_g83651).xyz );
				float3 lerpResult7927_g83454 = lerp( Blend_Emissive2476_g83454 , Terrain_Emissive7933_g83454 , Terrain_Mask7747_g83454);
				#ifdef TVE_TERRAIN
				float3 staticSwitch7912_g83454 = lerpResult7927_g83454;
				#else
				float3 staticSwitch7912_g83454 = Blend_Emissive2476_g83454;
				#endif
				half3 Blend_Emissive_Terrain7909_g83454 = staticSwitch7912_g83454;
				
				half Main_Metallic237_g83454 = ( tex2DNode35_g83454.r * _MainMetallicValue );
				half Second_Metallic226_g83454 = ( tex2DNode33_g83454.r * _SecondMetallicValue );
				float lerpResult278_g83454 = lerp( Main_Metallic237_g83454 , Second_Metallic226_g83454 , Detail_Mask147_g83454);
				#ifdef TVE_DETAIL
				float staticSwitch299_g83454 = lerpResult278_g83454;
				#else
				float staticSwitch299_g83454 = Main_Metallic237_g83454;
				#endif
				half Blend_Metallic_Detail306_g83454 = staticSwitch299_g83454;
				#ifdef TVE_PACKED_TEX
				float staticSwitch9139_g83651 = 0.0;
				#else
				float staticSwitch9139_g83651 = ( (Blend_Masks7420_g83651).x * (Blend_Params7547_g83651).x * _TerrainMetallicValue1 );
				#endif
				half Terrain_Metallic8097_g83454 = staticSwitch9139_g83651;
				float lerpResult7808_g83454 = lerp( Blend_Metallic_Detail306_g83454 , Terrain_Metallic8097_g83454 , Terrain_Mask7747_g83454);
				#ifdef TVE_TERRAIN
				float staticSwitch7807_g83454 = lerpResult7808_g83454;
				#else
				float staticSwitch7807_g83454 = Blend_Metallic_Detail306_g83454;
				#endif
				half Blend_Metallic_Terrain7813_g83454 = staticSwitch7807_g83454;
				float lerpResult342_g83454 = lerp( Blend_Metallic_Terrain7813_g83454 , 0.0 , Overlay_Mask269_g83454);
				half Blend_Metallic_Overlay367_g83454 = lerpResult342_g83454;
				
				float lerpResult240_g83454 = lerp( 1.0 , tex2DNode35_g83454.g , _MainOcclusionValue);
				half Main_Occlusion247_g83454 = lerpResult240_g83454;
				float lerpResult239_g83454 = lerp( 1.0 , tex2DNode33_g83454.g , _SecondOcclusionValue);
				half Second_Occlusion251_g83454 = lerpResult239_g83454;
				float lerpResult294_g83454 = lerp( Main_Occlusion247_g83454 , Second_Occlusion251_g83454 , Detail_Mask147_g83454);
				#ifdef TVE_DETAIL
				float staticSwitch310_g83454 = lerpResult294_g83454;
				#else
				float staticSwitch310_g83454 = Main_Occlusion247_g83454;
				#endif
				half Blend_Occlusion_Detail323_g83454 = staticSwitch310_g83454;
				#ifdef TVE_PACKED_TEX
				float staticSwitch9097_g83651 = 1.0;
				#else
				float staticSwitch9097_g83651 = ( (Blend_Masks7420_g83651).y * _TerrainOcclusionValue );
				#endif
				half Terrain_Occlusion8041_g83454 = staticSwitch9097_g83651;
				float lerpResult7815_g83454 = lerp( Blend_Occlusion_Detail323_g83454 , Terrain_Occlusion8041_g83454 , Terrain_Mask7747_g83454);
				#ifdef TVE_TERRAIN
				float staticSwitch7814_g83454 = lerpResult7815_g83454;
				#else
				float staticSwitch7814_g83454 = Blend_Occlusion_Detail323_g83454;
				#endif
				half Blend_Occlusion_Terrain7820_g83454 = staticSwitch7814_g83454;
				
				half Main_Smoothness227_g83454 = ( tex2DNode35_g83454.a * _MainSmoothnessValue );
				half Second_Smoothness236_g83454 = ( tex2DNode33_g83454.a * _SecondSmoothnessValue );
				float lerpResult266_g83454 = lerp( Main_Smoothness227_g83454 , Second_Smoothness236_g83454 , Detail_Mask147_g83454);
				#ifdef TVE_DETAIL
				float staticSwitch297_g83454 = lerpResult266_g83454;
				#else
				float staticSwitch297_g83454 = Main_Smoothness227_g83454;
				#endif
				half Blend_Smoothness_Detail314_g83454 = staticSwitch297_g83454;
				#ifdef TVE_PACKED_TEX
				float staticSwitch9105_g83651 = (Blend_Masks7420_g83651).x;
				#else
				float staticSwitch9105_g83651 = (Blend_Masks7420_g83651).w;
				#endif
				half Terrain_Smoothness8042_g83454 = ( staticSwitch9105_g83651 * (Blend_Params7547_g83651).w * _TerrainSmoothnessValue );
				float lerpResult7801_g83454 = lerp( Blend_Smoothness_Detail314_g83454 , Terrain_Smoothness8042_g83454 , Terrain_Mask7747_g83454);
				#ifdef TVE_TERRAIN
				float staticSwitch7800_g83454 = lerpResult7801_g83454;
				#else
				float staticSwitch7800_g83454 = Blend_Smoothness_Detail314_g83454;
				#endif
				half Blend_Smoothness_Terrain7806_g83454 = staticSwitch7800_g83454;
				half Global_OverlaySmoothness311_g83454 = TVE_OverlaySmoothness;
				float lerpResult343_g83454 = lerp( Blend_Smoothness_Terrain7806_g83454 , Global_OverlaySmoothness311_g83454 , Overlay_Mask269_g83454);
				half Blend_Smoothness_Overlay371_g83454 = lerpResult343_g83454;
				float temp_output_6499_0_g83454 = ( 1.0 - Wetness_Value6343_g83454 );
				half Blend_Smoothness_Wetness4130_g83454 = saturate( ( Blend_Smoothness_Overlay371_g83454 + ( 1.0 - ( temp_output_6499_0_g83454 * temp_output_6499_0_g83454 ) ) ) );
				
				float localCustomAlphaClip19_g83576 = ( 0.0 );
				half Main_Alpha316_g83454 = tex2DNode29_g83454.a;
				half Second_Alpha5007_g83454 = tex2DNode89_g83454.a;
				float lerpResult6153_g83454 = lerp( Main_Alpha316_g83454 , Second_Alpha5007_g83454 , Detail_Mask147_g83454);
				float lerpResult6785_g83454 = lerp( ( Main_Alpha316_g83454 * Second_Alpha5007_g83454 ) , lerpResult6153_g83454 , _DetailAlphaMode);
				#ifdef TVE_DETAIL
				float staticSwitch6158_g83454 = lerpResult6785_g83454;
				#else
				float staticSwitch6158_g83454 = Main_Alpha316_g83454;
				#endif
				half Blend_Alpha_Detail6157_g83454 = staticSwitch6158_g83454;
				half AlphaTreshold2132_g83454 = _AlphaClipValue;
				half Global_Alpha315_g83454 = 1.0;
				half Fade_Alpha3727_g83454 = 1.0;
				half Final_Alpha7344_g83454 = min( ( ( Blend_Alpha_Detail6157_g83454 - AlphaTreshold2132_g83454 ) * Global_Alpha315_g83454 ) , Fade_Alpha3727_g83454 );
				float temp_output_3_0_g83576 = Final_Alpha7344_g83454;
				float Alpha19_g83576 = temp_output_3_0_g83576;
				float temp_output_15_0_g83576 = 0.01;
				float Treshold19_g83576 = temp_output_15_0_g83576;
				{
				...
				clip(Alpha19_g83576 - Treshold19_g83576);
				#endif
				#else
				clip(Alpha19_g83576 - Treshold19_g83576);
				#endif
				...
				half Main_Color_Alpha6121_g83454 = (lerpResult7986_g83454).a;
				half Second_Color_Alpha6152_g83454 = (lerpResult7997_g83454).a;
				float lerpResult6168_g83454 = lerp( Main_Color_Alpha6121_g83454 , Second_Color_Alpha6152_g83454 , Detail_Mask147_g83454);
				#ifdef TVE_DETAIL
				float staticSwitch6174_g83454 = lerpResult6168_g83454;
				#else
				float staticSwitch6174_g83454 = Main_Color_Alpha6121_g83454;
				#endif
				half Blend_ColorAlpha_Detail6167_g83454 = staticSwitch6174_g83454;
				half Final_Clip914_g83454 = saturate( ( Alpha19_g83576 * Blend_ColorAlpha_Detail6167_g83454 ) );
				
				half3 Subsurface_Color1722_g83454 = ( (_SubsurfaceColor).rgb * Blend_Albedo_Wetness6351_g83454 );
				half Global_Subsurface4041_g83454 = TVE_SubsurfaceValue;
				half Global_OverlaySubsurface5667_g83454 = TVE_OverlaySubsurface;
				float lerpResult7362_g83454 = lerp( 1.0 , Global_OverlaySubsurface5667_g83454 , Overlay_Value5738_g83454);
				half Overlay_Subsurface7361_g83454 = lerpResult7362_g83454;
				half Subsurface_Intensity1752_g83454 = ( _SubsurfaceValue * Global_Subsurface4041_g83454 * Overlay_Subsurface7361_g83454 );
				half Subsurface_Mask1557_g83454 = 1.0;
				half3 Subsurface_Translucency884_g83454 = ( Subsurface_Color1722_g83454 * Subsurface_Intensity1752_g83454 * Subsurface_Mask1557_g83454 * 10.0 );
				
				o.Albedo = Blend_Albedo_RimLight7316_g83454;
				o.Normal = switchResult12_g83482;
				o.Emission = Blend_Emissive_Terrain7909_g83454;
					...
					o.Gloss = 0;
						...
						o.Specular = fixed3( 0, 0, 0 );
					#else
						o.Metallic = Blend_Metallic_Overlay367_g83454;
					#endif
					o.Occlusion = Blend_Occlusion_Terrain7820_g83454;
					o.Smoothness = Blend_Smoothness_Wetness4130_g83454;
				#endif

				o.Alpha = Final_Clip914_g83454;
				...
				float3 Translucency = Subsurface_Translucency884_g83454;
		...
		Pass
		{
			...
			v2f VertexFunction (appdata v  ) {
				...
				half2 Second_UVs_Offset7657_g83454 = (_SecondUVs).zw;
				float2 vertexToFrag11_g83519 = ( ( ( temp_output_30_0_g83520 + temp_output_29_0_g83520 + temp_output_31_0_g83520 ) * lerpResult7660_g83454 ) + Second_UVs_Offset7657_g83454 );
				o.ase_texcoord4.xy = vertexToFrag11_g83519;
				...
				float vertexToFrag11_g83589 = saturate( ( ( Global_VertexOffset7549_g83454 + Terrain_Blend_Offset8086_g83454 ) - (WorldPosition_Shifted7477_g83454).y ) );
				o.ase_texcoord4.z = vertexToFrag11_g83589;
				o.ase_texcoord9.xyz = vertexToFrag3890_g83454;
				o.ase_texcoord10.xyz = vertexToFrag4224_g83454;
				...
				) : SV_Target
			{
				...
				half2 Main_UVs15_g83454 = ( ( IN.ase_texcoord3.xy * (_MainUVs).xy ) + (_MainUVs).zw );
				float4 tex2DNode29_g83454 = SAMPLE_TEXTURE2D( _MainAlbedoTex, sampler_MainAlbedoTex, Main_UVs15_g83454 );
				float3 lerpResult6223_g83454 = lerp( float3( 1,1,1 ) , (tex2DNode29_g83454).rgb , _MainAlbedoValue);
				float4 tex2DNode35_g83454 = SAMPLE_TEXTURE2D( _MainMaskTex, sampler_Linear_Repeat, Main_UVs15_g83454 );
				half Main_Mask57_g83454 = tex2DNode35_g83454.b;
				...
				half3 Main_Color_RGB7994_g83454 = (lerpResult7986_g83454).rgb;
				half3 Main_Albedo99_g83454 = ( lerpResult6223_g83454 * Main_Color_RGB7994_g83454 );
				float2 vertexToFrag11_g83519 = IN.ase_texcoord4.xy;
				half2 Second_UVs17_g83454 = vertexToFrag11_g83519;
				float4 tex2DNode89_g83454 = SAMPLE_TEXTURE2D( _SecondAlbedoTex, sampler_SecondAlbedoTex, Second_UVs17_g83454 );
				float3 lerpResult6225_g83454 = lerp( float3( 1,1,1 ) , (tex2DNode89_g83454).rgb , _SecondAlbedoValue);
				float4 tex2DNode33_g83454 = SAMPLE_TEXTURE2D( _SecondMaskTex, sampler_Linear_Repeat, Second_UVs17_g83454 );
				...
				half4 Blend_Albedo7468_g83651 = staticSwitch40_g83663;
				half3 Terrain_Albedo8037_g83454 = ( (Blend_Albedo7468_g83651).xyz * (_TerrainColor).rgb );
				float vertexToFrag11_g83589 = IN.ase_texcoord4.z;
				half Terrain_Mask_Pixel7898_g83454 = vertexToFrag11_g83589;
				half2 Main_Normal137_g83454 = temp_output_6555_0_g83454;
				float2 lerpResult3372_g83454 = lerp( float2( 0,0 ) , Main_Normal137_g83454 , _DetailNormalValue);
				...
				float temp_output_19_0_g83477 = TVE_ColorsUsage[(int)temp_output_82_0_g83473];
				float4 temp_output_91_19_g83473 = TVE_ColorsCoords;
				float3 vertexToFrag3890_g83454 = IN.ase_texcoord9.xyz;
				float3 WorldPosition3905_g83454 = vertexToFrag3890_g83454;
				float3 vertexToFrag4224_g83454 = IN.ase_texcoord10.xyz;
				float3 ObjectPosition4223_g83454 = vertexToFrag4224_g83454;
				float3 lerpResult4822_g83454 = lerp( WorldPosition3905_g83454 , ObjectPosition4223_g83454 , _ColorsPositionMode);
				half2 UV94_g83473 = ( (temp_output_91_19_g83473).zw + ( (temp_output_91_19_g83473).xy * (lerpResult4822_g83454).xz ) );
				float4 tex2DArrayNode83_g83473 = SAMPLE_TEXTURE2D_ARRAY_LOD( TVE_ColorsTex, sampler_Linear_Clamp, float3(UV94_g83473,temp_output_82_0_g83473), 0.0 );
				...
				float3 temp_cast_19 = (0.0).xxx;
				half3 Emissive_Color7162_g83454 = (_EmissiveColor).rgb;
				half2 Emissive_UVs2468_g83454 = ( ( IN.ase_texcoord3.xy * (_EmissiveUVs).xy ) + (_EmissiveUVs).zw );
				float temp_output_7_0_g83586 = _EmissiveTexMinValue;
				float3 temp_cast_20 = (temp_output_7_0_g83586).xxx;
				float temp_output_10_0_g83586 = ( _EmissiveTexMaxValue - temp_output_7_0_g83586 );
				half3 Emissive_Texture7022_g83454 = saturate( ( ( (SAMPLE_TEXTURE2D( _EmissiveTex, sampler_Linear_Repeat, Emissive_UVs2468_g83454 )).rgb - temp_cast_20 ) / ( temp_output_10_0_g83586 + 0.0001 ) ) );
		...
		Pass
		{
			...
			v2f VertexFunction (appdata v  ) {
				...
				half2 Second_UVs_Offset7657_g83454 = (_SecondUVs).zw;
				float2 vertexToFrag11_g83519 = ( ( ( temp_output_30_0_g83520 + temp_output_29_0_g83520 + temp_output_31_0_g83520 ) * lerpResult7660_g83454 ) + Second_UVs_Offset7657_g83454 );
				o.ase_texcoord3.xy = vertexToFrag11_g83519;
				float3 ase_worldTangent = UnityObjectToWorldDir(v.tangent);
				...
				) : SV_Target
			{
				...
				float localCustomAlphaClip19_g83576 = ( 0.0 );
				half2 Main_UVs15_g83454 = ( ( IN.ase_texcoord2.xy * (_MainUVs).xy ) + (_MainUVs).zw );
				float4 tex2DNode29_g83454 = SAMPLE_TEXTURE2D( _MainAlbedoTex, sampler_MainAlbedoTex, Main_UVs15_g83454 );
				half Main_Alpha316_g83454 = tex2DNode29_g83454.a;
				float2 vertexToFrag11_g83519 = IN.ase_texcoord3.xy;
				half2 Second_UVs17_g83454 = vertexToFrag11_g83519;
				float4 tex2DNode89_g83454 = SAMPLE_TEXTURE2D( _SecondAlbedoTex, sampler_SecondAlbedoTex, Second_UVs17_g83454 );
				half Second_Alpha5007_g83454 = tex2DNode89_g83454.a;
				float4 tex2DNode35_g83454 = SAMPLE_TEXTURE2D( _MainMaskTex, sampler_Linear_Repeat, Main_UVs15_g83454 );
...
Node;AmplifyShaderEditor.RangedFloatNode;17;-1600,-768;Half;False;Property;_render_zw;_render_zw;430;1;[HideInInspector];Create;True;0;2;Opaque;0;Transparent;1;0;True;0;False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;397;-1408,-768;Half;False;Property;_render_coverage;_render_coverage;431;1;[HideInInspector];Create;True;0;2;Opaque;0;Transparent;1;0;True;0;False;0;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;813;-1664,512;Inherit;False;Define ShaderType Prop;432;;76747;96e31a47d32deff49ba83d5b364f536d;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;814;-1280,512;Inherit;False;Compile Blanket;-1;;79914;bff24eccb6f21f7419015d541a074b70;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;828;-1936,512;Inherit;False;Define Lighting Subsurface;434;;83150;77137addbb4a22f4c818adc8782926be;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;830;-1152,-384;Float;False;False;-1;2;ASEMaterialInspector;0;1;New Amplify Shader;28cd5599e02859647ae1798e4fcaef6c;True;ExtraPrePass;0;0;ExtraPrePass;6;False;True;0;1;False;;0;False;;0;1;False;;0;False;;True;0;False;;0;False;;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;False;True;3;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;DisableBatching=False=DisableBatching;True;2;False;0;False;True;1;1;False;;0;False;;0;1;False;;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;1;LightMode=ForwardBase;False;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;831;-1152,-384;Float;False;True;-1;2;TVEShaderCoreGUI;0;18;BOXOPHOBIC/The Vegetation Engine/Geometry/Prop Subsurface Lit (Blanket);28cd5599e02859647ae1798e4fcaef6c;True;ForwardBase;0;1;ForwardBase;20;False;True;0;1;False;;0;False;;0;1;False;;0;False;;True;0;False;;0;False;;False;False;False;False;False;False;False;False;False;True;0;True;_render_coverage;True;True;2;True;_render_cull;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;True;True;1;True;_render_zw;True;0;False;;False;True;3;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;DisableBatching=False=DisableBatching;True;5;False;0;True;True;1;1;True;_render_src;0;True;_render_dst;0;1;False;;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=ForwardBase;False;False;0;Hidden/BOXOPHOBIC/The Vegetation Engine/Fallback;0;0;Standard;41;Category;0;0;Workflow;1;0;Surface;0;0;  Blend;0;0;  Refraction Model;0;0;  Dither Shadows;1;0;Two Sided;0;638375498735936403;Deferred Pass;0;638375498750537578;Transmission;0;0;  Transmission Shadow;0.5,False,;0;Translucency;1;638375498760539068;  Translucency Strength;1,False,;0;  Normal Distortion;0.5,False,;0;  Scattering;2,False,;0;  Direct;0.9,False,;0;  Ambient;0.1,False,;0;  Shadow;0.5,False,;0;Cast Shadows;1;0;  Use Shadow Threshold;0;0;Receive Shadows;1;0;GPU Instancing;1;0;LOD CrossFade;1;0;Built-in Fog;1;0;Ambient Light;1;0;Meta Pass;1;0;Add Pass;1;0;Override Baked GI;0;0;Extra Pre Pass;0;0;Tessellation;0;0;  Phong;0;0;  Strength;0.5,False,;0;  Type;0;0;  Tess;16,False,;0;  Min;10,False,;0;  Max;25,False,;0;  Edge Length;16,False,;0;  Max Displacement;25,False,;0;Fwd Specular Highlights Toggle;0;0;Fwd Reflections Toggle;0;0;Disable Batching;0;0;Vertex Position,InvertActionOnDeselection;0;638375498796336557;0;6;False;True;True;False;True;True;False;;True;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;832;-1152,-384;Float;False;False;-1;2;ASEMaterialInspector;0;1;New Amplify Shader;28cd5599e02859647ae1798e4fcaef6c;True;ForwardAdd;0;2;ForwardAdd;0;False;True;0;1;False;;0;False;;0;1;False;;0;False;;True;0;False;;0;False;;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;False;True;3;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;DisableBatching=False=DisableBatching;True;2;False;0;False;True;4;1;False;;1;False;;0;1;False;;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;2;False;;False;False;True;1;LightMode=ForwardAdd;False;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;833;-1152,-384;Float;False;False;-1;2;ASEMaterialInspector;0;1;New Amplify Shader;28cd5599e02859647ae1798e4fcaef6c;True;Deferred;0;3;Deferred;0;False;True;0;1;False;;0;False;;0;1;False;;0;False;;True;0;False;;0;False;;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;False;True;3;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;DisableBatching=False=DisableBatching;True;2;False;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=Deferred;True;2;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;834;-1152,-384;Float;False;False;-1;2;ASEMaterialInspector;0;1;New Amplify Shader;28cd5599e02859647ae1798e4fcaef6c;True;Meta;0;4;Meta;0;False;True;0;1;False;;0;False;;0;1;False;;0;False;;True;0;False;;0;False;;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;False;True;3;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;DisableBatching=False=DisableBatching;True;2;False;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;2;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=Meta;False;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;835;-1152,-384;Float;False;False;-1;2;ASEMaterialInspector;0;1;New Amplify Shader;28cd5599e02859647ae1798e4fcaef6c;True;ShadowCaster;0;5;ShadowCaster;0;False;True;0;1;False;;0;False;;0;1;False;;0;False;;True;0;False;;0;False;;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;False;True;3;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;DisableBatching=False=DisableBatching;True;2;False;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;False;;True;3;False;;False;True;1;LightMode=ShadowCaster;False;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.FunctionNode;836;-2176,-384;Inherit;False;Base Blanket;0;;83454;ec9d184f5c74f2c41b1d23a5abd72b0a;105,7343,0,3880,1,4028,1,3900,1,3908,1,4172,1,8021,1,8022,1,4179,1,1298,1,6791,1,6792,1,1300,1,3586,0,4499,1,1708,1,6056,1,3509,1,3873,0,893,0,6230,0,5156,1,5345,0,1715,1,1714,1,1718,1,1717,1,6116,1,5075,1,7607,1,6076,1,6592,1,6068,1,6692,0,6729,1,1776,0,6378,1,3475,1,6352,1,6655,1,4210,1,1745,0,3479,0,1646,0,3501,0,2807,0,6206,0,7606,0,4999,0,6194,0,3887,0,7321,0,7332,0,3957,0,6647,0,6257,0,5357,0,2172,0,3883,0,3728,1,5350,0,2658,0,7669,0,1742,0,3484,0,6320,1,1734,1,4837,1,6848,1,6161,1,6166,1,1735,1,1736,1,6622,1,1737,1,7817,1,7913,1,7923,1,7810,1,7803,1,7791,1,7795,1,7897,1,7429,0,7941,0,6721,0,860,0,2260,1,2261,1,2054,1,2032,1,5258,0,2062,1,2039,1,7588,1,7586,1,3243,0,5220,0,4217,1,6699,1,5339,0,8019,1,7492,0,5090,1,4242,1;9;7333;FLOAT3;1,1,1;False;6196;FLOAT;1;False;6693;FLOAT;1;False;6201;FLOAT;1;False;6205;FLOAT;1;False;5143;FLOAT;1;False;6231;FLOAT;1;False;6198;FLOAT;1;False;5340;FLOAT3;0,0,0;False;24;FLOAT3;0;FLOAT3;528;FLOAT3;2489;FLOAT;531;FLOAT;4842;FLOAT;529;FLOAT;3678;FLOAT;530;FLOAT;4122;FLOAT;4134;FLOAT;1235;FLOAT;532;FLOAT;5389;FLOAT;721;FLOAT3;1230;FLOAT;5296;FLOAT;1461;FLOAT;1290;FLOAT;629;FLOAT3;534;FLOAT3;7780;FLOAT;4867;FLOAT4;5246;FLOAT4;4841
WireConnection;831;0;836;0
WireConnection;831;1;836;528
WireConnection;831;2;836;2489
WireConnection;831;4;836;529
WireConnection;831;6;836;531
WireConnection;831;5;836;530
WireConnection;831;7;836;532
WireConnection;831;14;836;1230
WireConnection;831;15;836;534
WireConnection;831;16;836;7780
ASEEND*/
//CHKSM=F9A93725F43CC154F10596DFC8CC1E88D1EB34F4