...
namespace TheVegetationEngineBlanket
{
    public class TVETBHub : EditorWindow
    {
        ...
        string autorunPath;
        string assetFolder = "Assets/BOXOPHOBIC/The Vegetation Engine Modules/Terrain Blanket";
        ...
        [MenuItem("Window/BOXOPHOBIC/The Vegetation Engine/Hub/Terrain Blanket", false, 1006)]
        ...
        void OnGUI()
        {
            ...
            {
                EditorGUILayout.HelpBox("Welcome to the Terrain Blanket Module for the Vegetation Engine! Choose the render pipeline used in your project to make the shaders compatible with the current pipeline!", MessageType.Info, true);
        ...
        void SetDefineSymbols()
        {
            ...
            if (!defineSymbols.Contains("THE_VEGETATION_ENGINE_BLANKET"))
            {
                defineSymbols += ";THE_VEGETATION_ENGINE_BLANKET;";
