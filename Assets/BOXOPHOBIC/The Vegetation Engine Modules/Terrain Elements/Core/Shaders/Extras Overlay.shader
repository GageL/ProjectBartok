...
Shader "BOXOPHOBIC/The Vegetation Engine/Elements/Extras Overlay (Terrain)"
{
	Properties
	{
		[StyledMessage(Info, Use the Overlay elements to dampen the overlay effect on vegetation or static props. Make sure the element size matches your terrain., 0,0)]_ElementMessage("Element Message", Float) = 0
	...
	LOD 100
		...
		Pass
		{
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				half4 appendResult283_g18648 = (half4(0.0 , 0.0 , Terrain_Values153_g18648 , Element_Intensity235_g18648));
		...
		Pass
		{
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				half3 Input_Color94_g22076 = temp_cast_5;
				half3 break68_g22076 = Input_Color94_g22076;
				half clampResult80_g22076 = clamp( max( max( break68_g22076.x , break68_g22076.y ) , break68_g22076.z ) , 0.1 , 10000.0 );
				half4 color573_g18648 = IsGammaSpace() ? half4(0.2,0.5019608,1,0) : half4(0.03310476,0.2158605,1,0);
				half3 Input_Tint76_g22076 = (color573_g18648).rgb;
				half3 Element_Valid47_g22076 = ( clampResult80_g22076 * Input_Tint76_g22076 );
				half4 Colors37_g22088 = TVE_ColorsPosition;
				half4 Extras37_g22088 = TVE_ExtrasPosition;
				half4 Motion37_g22088 = TVE_MotionPosition;
				half4 Vertex37_g22088 = TVE_VertexPosition;
				half4 localIS_ELEMENT37_g22088 = IS_ELEMENT( Colors37_g22088 , Extras37_g22088 , Motion37_g22088 , Vertex37_g22088 );
				half4 Colors37_g22089 = TVE_ColorsScale;
				half4 Extras37_g22089 = TVE_ExtrasScale;
				half4 Motion37_g22089 = TVE_MotionScale;
				half4 Vertex37_g22089 = TVE_VertexScale;
				half4 localIS_ELEMENT37_g22089 = IS_ELEMENT( Colors37_g22089 , Extras37_g22089 , Motion37_g22089 , Vertex37_g22089 );
				half Bounds42_g22076 = ( 1.0 - saturate( ( distance( max( ( abs( ( WorldPosition - (localIS_ELEMENT37_g22088).xyz ) ) - ( (localIS_ELEMENT37_g22089).xyz * float3( 0.5,0.5,0.5 ) ) ) , float3( 0,0,0 ) ) , float3( 0,0,0 ) ) / 0.001 ) ) );
				half3 lerpResult50_g22076 = lerp( temp_cast_0 , Element_Valid47_g22076 , Bounds42_g22076);
				half CrossHatch44_g22076 = ( saturate( ( ( abs( sin( ( ( WorldPosition.x + WorldPosition.z ) * 3.0 ) ) ) - 0.7 ) * 100.0 ) ) * 0.25 );
				half TVE_SeasonOptions_X66_g18648 = TVE_SeasonOptions.x;
				half Additional_Value_Winter90_g18648 = _AdditionalValue1;
				half Additional_Value_Spring88_g18648 = _AdditionalValue2;
				half temp_output_7_0_g22193 = _SeasonMinValue;
				...
				half lerpResult18_g22185 = lerp( 1.0 , ( 1.0 - saturate( ( (temp_output_12_0_g22185).x + (temp_output_12_0_g22185).y ) ) ) , _ElementVolumeFadeMode);
				half Element_Intensity235_g18648 = ( _ElementIntensity * Element_Inflience461_g18648 * lerpResult18_g22185 );
				half Input_Alpha48_g22076 = Element_Intensity235_g18648;
				half lerpResult57_g22076 = lerp( CrossHatch44_g22076 , Input_Alpha48_g22076 , Bounds42_g22076);
				half4 appendResult58_g22076 = (half4(lerpResult50_g22076 , lerpResult57_g22076));
				
				
				finalColor = appendResult58_g22076;
				return finalColor;
			}
			ENDCG
		}
...
/*ASEBEGIN
Version=19202
Node;AmplifyShaderEditor.FunctionNode;118;-384,-1152;Inherit;False;Base Element Terrain;11;;18648;a84c2b02263ac4b42be9eb75f696cb74;6,222,1,558,1,557,2,225,2,582,1,589,1;1;609;FLOAT;1;False;2;FLOAT4;230;FLOAT4;550
...
Node;AmplifyShaderEditor.RangedFloatNode;111;-640,-1408;Half;False;Property;_ElementMessage;Element Message;0;0;Create;True;0;0;0;True;1;StyledMessage(Info, Use the Overlay elements to dampen the overlay effect on vegetation or static props. Make sure the element size matches your terrain., 0,0);False;0;0;1;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;120;-64,-1152;Half;False;True;-1;2;TVEShaderElementGUI;100;16;BOXOPHOBIC/The Vegetation Engine/Elements/Extras Overlay (Terrain);f4f273c3bb6262d4396be458405e60f9;True;VolumePass;0;0;VolumePass;2;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderType=Transparent=RenderType;Queue=Transparent=Queue=0;DisableBatching=True=DisableBatching;False;False;0;True;True;2;5;False;;10;False;;0;1;False;;0;False;;True;0;False;;0;False;;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;True;True;False;False;True;False;0;False;;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;True;True;2;False;;True;0;False;;True;False;0;False;;0;False;;False;True;2;False;0;;0;0;Standard;1;Vertex Position,InvertActionOnDeselection;1;0;0;2;True;True;False;;False;0
...
ASEEND*/
//CHKSM=12771AAE25CD19110B35194EEFBB34132B71B84D